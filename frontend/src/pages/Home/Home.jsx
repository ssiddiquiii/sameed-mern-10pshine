...
const Home = () => {
  ...
  return (
    <>
      ...
      <button
        className="w-16 h-16 flex items-center justify-center rounded-2xl bg-blue-600 hover:bg-blue-700 absolute right-10 bottom-10 transition-all shadow-lg hover:shadow-2xl hover:-translate-y-1"
        onClick={() => {
